...
def PRD_MO_ExecuteBillQuery():
    para = {
        "FormId": "PRD_MO",
        "FieldKeys": "FBillNo,FMaterialID.FName,FQty,FPlanStartDate,FPlanFinishDate,FMaterialID.FNumber,FStatus,FCreateDate,FDescription",
        "FilterString": "FStatus='3' OR FStatus='4'"
    }
