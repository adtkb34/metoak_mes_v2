...
export async function fetchDashboardProducts(
  ...
  { label: "FV-C01-V01 商用车_M55H竖版单目一体机_镜头模组半成品_01_V1.0 (800.00061)", code: "800.00061" },
  ...
  { label: "双目视觉限高碰撞预警,带车道偏离 (1000.01023)", code: "1000.01023" },
  ...
  { label: "定制版景区自动驾驶低速车智能套件 (1000.00041)", code: "1000.00041" },
